...
void Exit();
int menu();
void display(int (*position)[3],int name1,int name2,int player1_count,int player2_count,int player,int *arr2[9][8],int guti);
...
void hint(int *arr[3][3],int player,int *arr2[9][8],int get);
int antiShortCut(int i,int j);
    ...
    switch(menu_item)
    {
        case 1:
            ...
            for(;;)
            {
                ...
                int get=NULL;
                display(position,name1,name2,player1_count,player2_count,1,A,get);
                ...
                for(;;)
                {
                   ...
                   //... 1st Player turn........
                    if(a%2==0)
                    {
                        ...
                        get=NULL;
                        system("cls");
                        display(position,name1,name2,player1_count,player2_count,player,A,NULL);
                        //hint(position,player,A,get);
                        printf("%s's turn: \n",name3);
                        printf("Move point: ");
                        scanf("%d",&i);

                        system("cls");
                        display(position,name1,name2,player1_count,player2_count,player,A,i);
                       // hint(position,player,A,i);
                        printf("%s's turn: \n",name3);
            ...
            case 5:
                ...
                printf("\t************************************************************\n");
                     printf("\t************************************************************\n");
                     Sleep(300);
                     printf("\t!Each player have 3 pawn on their base  position.          !\n");
                     Sleep(300);
                     printf("\t!1st player move his pawn, but he/she has some restrictions!\n");
                     Sleep(300);
                     printf("\t!Player can’t take extra move or, he can't skip his steps. !\n");
                     Sleep(300);
                     printf("\t!If a player can match his three pawn in middle position on!\n");
                     Sleep(300);
                     printf("\t!the board or, diagonally match three pawn or opposite side!\n");
                     Sleep(300);
                     printf("\t!of the board if he can match three pawn then the player wi!\n");
                     Sleep(300);
                     printf("\t!ll win and the game will over untill any player get 3point!\n");
                     Sleep(300);
                     printf("\t************************************************************\n");
                     Sleep(300);
                     printf("\t************************************************************\n");
            ...
            case 6:
                ...
                Sleep(500);
                     ...
                     printf("\t************************************************************\n");
                     Sleep(300);
                     printf("\t!The name of our game is guti-baj. Before made this game   !\n");
                     Sleep(300);
                     printf("\t!we thought a lots of things but.suddenly we decided that  !\n");
                     Sleep(300);
                     printf("\t!we can develop our traditional game.this game is known as !\n");
                     Sleep(300);
                     printf("\t!difference types of name by according to different area of!\n");
                     Sleep(300);
                     printf("\t!bangladesh.then we start to made this game by helping our !\n");
                     Sleep(300);
                     printf("\t!teacher mukul sir. we have a lot of plan about this game..!\n");
                     Sleep(300);
                     printf("\t************************************************************\n");
                     Sleep(300);
                     printf("\t************************************************************\n");
...
void display(int (*position)[3],int name1,int name2,int player1_count,int player2_count,int player,int *arr2[9][8],int guti)
{
    ...
    printf("   %c   |    \\|/    |                            %c\n",176,176);
    printf("     %c         %c%c%c%c%c         %c",c,c,c,c,c,c,c);
    printf("   %c  [4]---[5]---[6]   HINT:                   %c\n",176,176);
    printf("     %c        %c %c%c%c %c        %c",c,c,c,c,c,c,c);
    printf("   %c   |    /|\\    |   ",176);
    hint(position,player,arr2,guti);
    printf("                   %c\n",176);
    printf("     %c       %c  %c%c%c  %c       %c",c,c,c,c,c,c,c);
    printf("   %c   |  /  |  \\  |                            %c\n",176,176);
    printf("     %c      %c   %c%c%c   %c      %c",c,c,c,c,c,c,c);
...
void hint(int *arr[3][3],int player,int *arr2[9][8],int guti)
{
   int i ,j,pos[3],index=0;
    if (player==1)
    {
            for(i=0;i<3;i++)
            {
    ...
    if(guti!=NULL)
    {
        ...
        }else
        {
            ...
            printf("%d %d %d ",arr2[guti][0],arr2[guti][1],arr2[guti][2]);// Position ta ber korte hbe.........
